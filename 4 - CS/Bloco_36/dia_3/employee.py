...
employees = [(14, "Matheus"), (23, "Antonio"), (10, "Silva"), (9, "Zeon")]
registries = HashMap()

for id_num, name in employees:
    employee = Employee(id_num=id_num, name=name)
    registries.insert(employee=employee)

print(registries.get_value(9))
